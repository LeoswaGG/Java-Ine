        ...
        <main>            
            <article class="hero-image">
                <div class="container">
                    ...
                    <%}%>
                    <form class="form" method="post" action="validVotante" autocomplete="off">
                        <p class="form-title">Ingresa los datos para poder votar</p>
                        <div class="input-container">
                            <input type="number" placeholder="Ingresa tu Id" name="idVotante" required>
